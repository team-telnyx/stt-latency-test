...
**RTT (Round-Trip Time)** — Network latency between your machine and the server. We subtract this so the numbers measure the engine, not your internet connection.
